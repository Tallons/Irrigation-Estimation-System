...
CREATE TABLE bids_materials (
   bid_id INT REFERENCES bids(bid_id),
   material_id INT REFERENCES materials(material_id)
);

INSERT INTO bids_materials (bid_id, material_id)
VALUES (1, 1), (1,2);
   ...
   INSERT INTO materials (material_type, material_name, unit_cost)
      ...
      CREATE TABLE material_types (
         ...
         material_type VARCHAR(150));
            ...
            VALUES ('Pipe'), ('Controller');

         CREATE TABLE material_type_materials (
            type_id INT REFERENCES material_types(type_id),
            material_id INT REFERENCES materials(material_id));
               
            INSERT INTO material_type_materials (type_id, material_id)
            VALUES (1, 1), (2, 2), (1, 3); 
...
CREATE TABLE materials_tasks (
   ...
   INSERT INTO materials_tasks (material_id, task_id, material_quantity)
      VALUES (1, 1, 1000), (2, 2, 2);
